...
function ThreeSixtyPlayer() {
  ...
  this.config = {
    ...
    loadRingColor: '#00692E', // how much has loaded
    playRingColor: '#49B800', // how much has played
    backgroundRingColor: '#BF0033', // color shown underneath load + play ("not yet loaded" color)
...
//    if (foundItems>0) {
// 		Fucking idiot binds the DOCUMENT!!!! WTF!!!
